...
popHist=popHist+geom_histogram(binwidth = 600000)
...
assHist=assHist+geom_histogram(binwidth=10)
...
rapeHist=rapeHist+geom_histogram(binwidth=1)
...
urbanHist=urbanHist+geom_histogram(binwidth=2)
